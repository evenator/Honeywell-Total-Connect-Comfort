...
class Client(object):
    def __init__(self, username, password):
        ...
        self.session.headers.update({'User-Agent': 'MyTotalConnectComfortClient/0.1'})
        self.login()
    ...
    def get_location_data(self, location_id):
        path = '{}Device/GetZoneListData?locationId={}&page=1'.format(PORTAL, location_id)
        return self.get_json(path)
    ...
    def get_device_data(self, device_id, utc_seconds=None):
        ...
        path = '{}Device/CheckDataSession/{}?_={}'.format(PORTAL, device_id, utc_seconds)
